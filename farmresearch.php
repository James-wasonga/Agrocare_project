...
<header class="page-header">
    ...
    <div class="body">
<div>
<h1 class="pest-head">Farm Research</h1>
...
<div class="research">
    ...
    <img src="/images/research2.png" alt="" class="research-img">
    </div>
<div>
...
<div>
    ...
    <div>
        ...
        <p class="supp-graph">We are the center of all research for all crops and livestock researchs</p>
        <button class="hire-btn" onclick="displayPaymentForm()">Hire </button>
        </div>
</div>
</div>
